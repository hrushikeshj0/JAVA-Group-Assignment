...
public class mismatch 
{
	public static void main(String[] args) throws IOException 
	{
        ...
        BufferedReader TextFile1 = new BufferedReader(new FileReader("C:\Users\Admin\Desktop\Helloworld\file1.txt"));         
        BufferedReader TextFile2 = new BufferedReader(new FileReader("C:\Users\Admin\Desktop\Helloworld\file2.txt"));
        ...
        if(file)
        {
            System.out.println("Data present in the two given sources match.");
        }
        else
        {
